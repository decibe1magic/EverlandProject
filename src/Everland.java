...
public class Everland {
	...
	public static void main(String[] args) {
		...
		while (true) {
			count = 0;
			clearAll(selectDate, regNum, quantity, preferentialNum);
			do {
				inputDate(selectDate,count);
				inputRegNum(regNum,count);
				inputQuantity(quantity,count);
				inputPreferentialNum(preferentialNum,count);
				count++;
	...
	public static ArrayList<String> inputDate(ArrayList<String> selectDate, int count) {
		Scanner sc = new Scanner(System.in);
	...
	public static ArrayList<String> inputRegNum(ArrayList<String> regNum, int count) {
		Scanner sc = new Scanner(System.in);
	...
	public static ArrayList<Integer> inputQuantity(ArrayList<Integer> quantity, int count) {
		Scanner sc = new Scanner(System.in);
	...
	public static ArrayList<Integer> inputPreferentialNum(ArrayList<Integer> preferentialNum, int count) {
		Scanner sc = new Scanner(System.in);
	...
	public static void clearAll(ArrayList<String> selectDate, ArrayList<String> regNum, ArrayList<Integer> quantity,
